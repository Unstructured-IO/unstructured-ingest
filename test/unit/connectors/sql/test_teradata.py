...
class TestTeradataConnectionConfig:
    """Test Teradata-specific connection configuration."""

    def test_connection_config_with_database(self, teradata_access_config: TeradataAccessConfig):
    ...
    def test_connection_config_default_port(self, teradata_access_config: TeradataAccessConfig):
        config = TeradataConnectionConfig(
            host="test-host.teradata.com",
            user="test_user",
            access_config=Secret(teradata_access_config),
...
class TestTeradataDownloader:
    """Test Teradata-specific downloader functionality."""

    def test_query_db_quotes_identifiers(
        self,
    ...
    def test_query_db_returns_correct_data(
        self,
        mock_cursor: MagicMock,
        teradata_downloader: TeradataDownloader,
        mock_get_cursor: MagicMock,
...
class TestTeradataUploadStager:
    """Test Teradata-specific upload staging functionality."""

    def test_conform_dataframe_converts_lists_to_json(
        self, teradata_upload_stager: TeradataUploadStager
    ):
    ...
    def test_conform_dataframe_converts_dicts_to_json(
        self, teradata_upload_stager: TeradataUploadStager
    ):
    ...
    def test_conform_dataframe_handles_empty_dataframe(
        self, teradata_upload_stager: TeradataUploadStager
    ):
    ...
    def test_conform_dataframe_handles_none_values(
        self, teradata_upload_stager: TeradataUploadStager
    ):
...
class TestTeradataUploader:
    """Test Teradata-specific uploader functionality."""

    def test_get_table_columns_uses_top_syntax(
        self,
        mock_cursor: MagicMock,
    ...
    def test_delete_by_record_id_quotes_identifiers(
        self,
        mock_cursor: MagicMock,
        teradata_uploader: TeradataUploader,
        mock_get_cursor: MagicMock,
    ...
    def test_upload_dataframe_quotes_column_names(
        self,
    ...
    def test_values_delimiter_is_qmark(self, teradata_uploader: TeradataUploader):
