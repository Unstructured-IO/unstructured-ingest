...
# shellcheck disable=SC1091
source "$SCRIPT_DIR"/env_setup/airtable/component_ids.sh
...
"$SCRIPT_DIR"/env_setup/airtable/check-num-rows-and-columns-output.sh 39999 "$OUTPUT_DIR"/"$LARGE_TABLE_BASE_ID"/"$LARGE_TABLE_TABLE_ID".json
