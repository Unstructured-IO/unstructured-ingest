...
class AzureCognitiveSearchUploadStager(UploadStager):
    ...
    def conform_dict(data: dict) -> dict:
        ...
        # For AzureCognitiveSearch we desire the index to reuse items in the index, and update them if there is a change, therfore we will keep the element_id as the key for the index instead of a unique id each time which adds duplicate entries.
