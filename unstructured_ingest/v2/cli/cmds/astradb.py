...
from unstructured_ingest.v2.processes.connectors.astradb import CONNECTOR_TYPE
    ...
    def get_cli_options() -> list[click.Option]:
        options = [
            click.Option(
                ...
                required=True,
                type=str,
                help="Astra DB Application Token with access to the database.",
