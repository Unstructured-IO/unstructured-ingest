...
from .databricks_volumes import databricks_volumes_destination_entry, databricks_volumes_source_entry
...
add_source_entry(source_type=DATABRICKS_VOLUMES_CONNECTOR_TYPE, entry=databricks_volumes_source_entry)
