...
class SharepointUploaderConfig(UploaderConfig):
    remote_url: str = Field(
        description="URL of the destination in Sharepoint, e.g., 'onedrive://Documents/Folder'"
    )
    prefix: str = "onedrive://"
...
@dataclass
class SharepointUploader(Uploader):
    connection_config: SharepointConnectionConfig
    upload_config: SharepointUploaderConfig
...
sharepoint_destination_entry = DestinationRegistryEntry(
    connection_config=SharepointConnectionConfig,
    uploader=SharepointUploader,
    uploader_config=SharepointUploaderConfig,
)
