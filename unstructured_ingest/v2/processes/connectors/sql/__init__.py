...
from .databricks_delta_tables import databricks_delta_table_destination_entry
...
add_destination_entry(
    destination_type=DATABRICKS_DELTA_TABLES_CONNECTOR_TYPE, entry=databricks_delta_table_destination_entry
)
